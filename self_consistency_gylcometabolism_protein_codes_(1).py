# -*- coding: utf-8 -*-
"""self_consistency_Gylcometabolism_protein_codes (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Apargj1cJLAQtT0bVjsIa2PKnxZjp2Eo
"""
...
# Predict on the same dataset (self-consistency validation)
...
# Step 4: Train the Model (Self-Consistency: Train and Test on the Same Data)
history = MLP.fit(X, Y, epochs=25, batch_size=32, verbose=1)
...
plt.plot(rf_fpr, rf_tpr,  lw=2, label='ROC curve (RF Self-Consistency AUC = % 0.3f)' % roc_auc_test)
