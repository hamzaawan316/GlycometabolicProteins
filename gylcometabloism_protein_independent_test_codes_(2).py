# -*- coding: utf-8 -*-
"""GylcoMetabloism_Protein_Independent_Test_codes (2).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XyFJCWslt6HBhy0lNubOD41qRgskYX0e
"""
...
dftrain = pd.read_csv('/content/GulcoMetabolismCD-HIT0.6 ver 2.csv')
#df.head()
...
mlp_models = Sequential([
    Dense(256, activation='relu', input_shape=(153,)),  # input = 153 features
    BatchNormalization(),
    Dropout(0.3),
...
mlp_models.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
...
rnn_model = Sequential([
    SimpleRNN(128, activation='tanh', return_sequences=True, input_shape=(153, 1)),
    Dropout(0.2),
...
# Train the RNN model
rnn_model.fit(X_train, Y_train, validation_split=0.2, epochs=100, batch_size=32, verbose=1)
...
balanced_acc = balanced_accuracy_score(Y_test, rnn_pred_classes)
...
mcc = matthews_corrcoef(Y_test, rnn_pred_classes)
...
balanced_acc = balanced_accuracy_score(Y_test, lstm_pred_classes)
precision = precision_score(Y_test, lstm_pred_classes)
recall = recall_score(Y_test, lstm_pred_classes)  # Sensitivity
f1 = f1_score(Y_test, lstm_pred_classes)
roc_auc = roc_auc_score(Y_test, lstm_predictions)
mcc = matthews_corrcoef(Y_test, lstm_pred_classes)
